        ...
        <div>
            ...
            <div className='mx-40'>
                ...
                <div className='flex p-4 mb-4 justify-evenly bg-white shadow-lg rounded-b-xl rounded-t-0 overflow-hidden border border-gray-200'>
                    <div>
                        <button type="button" className='flex p-3 px-16 items-center gap-2 bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200 hover:bg-gray-200 hover:cursor-pointer'>
